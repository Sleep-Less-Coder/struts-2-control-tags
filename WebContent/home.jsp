...
<body>
	...
	<br>
	<br> Sorting the list of cities
	<br>
	<s:bean name="com.hemant.struts2.util.StringComparator"
	...
	<br>
	<br> Generate an iterator
	<s:generator separator="|" val="%{'apple|ball|orange|pineapple'}"
		var="fruitsIterator"></s:generator>
